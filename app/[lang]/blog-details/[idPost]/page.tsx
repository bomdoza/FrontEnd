...
const BlogDetailsPage = ({ params }) => {
  ...
  return (
    <>
      <BreadcrumbBack pageName="Post Detalhe" description="" url="/blog" />
      <section className="pb-[50px] pt-[25px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-center text-2xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-3xl">
                ...
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  <div className="flex flex-wrap items-center">
                    <div className="mb-5 mr-10 flex items-center justify-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 justify-center overflow-hidden rounded-full">
                          {selectedBlog && (
                            <Image
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                          Por{" "}
                          <span>
                            {selectedBlog && selectedBlog.author.name}
                          </span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center">
                      <p className="mr-5 flex items-center text-base font-medium text-body-color">
                        ...
                        {selectedBlog && selectedBlog.publishDate}
                      </p>
                      {/*
                      <p className="mr-5 flex items-center text-base font-medium text-body-color">
                        <span className="mr-3">
                  ...
                  <div className="mb-5">
                    ...
                    >
                      {selectedBlog && selectedBlog.tags}
                    </a>
                  </div>
                </div>
                <div>
                  <p className="mb-10 text-justify text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    {selectedBlog && selectedBlog.paragraph}
                  </p>
                  ...
                  <p className="mb-8 text-justify text-base  font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    {selectedBlog && selectedBlog.paragraph2}
                  </p>
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                    {selectedBlog && selectedBlog.topicDes.title}
                  </h3>
                  <p className="mb-10 text-base text-justify font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    {selectedBlog && selectedBlog.topicDes.desc}
                  </p>
                  <ul className="mb-10 list-inside list-disc text-body-color">
                    {selectedBlog && selectedBlog.topicDes.topic.map((tópico, índice) => (
                      <li
                        key={índice}
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      {selectedBlog && selectedBlog.concluding}
                    </p>
