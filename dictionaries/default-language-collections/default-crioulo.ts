export const crioulo = {
  ...
  abaut: {
    title: "Sobre Nós",
    description:
      "Bem-vindo à BomDoza, sua solução completa para serviços de lavagem. Nossa empresa é especializada em proporcionar cuidados meticulosos a uma variedade de itens, desde a limpeza detalhada de carros até a revitalização de sofás, tapetes e tanques. Com uma equipe altamente qualificada e equipamentos modernos, garantimos resultados excepcionais em cada serviço.",
    ExcellenceSection: {
      title: "Compromisso com a Excelência desde o Início",
      description:
        "Na BomDoza, a busca incessante pela excelência é uma parte intrínseca de nossa identidade. Desde os primeiros dias da nossa jornada, comprometemo-nos a proporcionar aos nossos clientes uma experiência de lavagem de carros e serviços de limpeza que transcende as expectativas convencionais.",
      Feature: [
        {
          id: 1,
          icon: "qualityIcon",
    ...
    AboutSectionTwo: {
      ...
      div1Description:
        " A BomDoza oferece uma gama de serviços de qualidade. Não se trata apenas de lavagem, é sobre restaurar, rejuvenescer e elevar a experiência de cuidado com seus pertences. Escolha a qualidade, escolha a dedicação, escolha a BomDoza para transformar a limpeza em uma experiência excepcional.",
