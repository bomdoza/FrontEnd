...
const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div
        className="wow fadeInUp relative z-10 rounded-sm bg-gray-200  px-8 py-10 shadow-three hover:shadow-one dark:bg-dark dark:shadow-two dark:hover:shadow-gray-dark"
        data-wow-delay=".1s"
      >
        <div className="flex items-center justify-between">
          <h3 className="price mb-2 text-3xl font-bold text-black dark:text-white">
            $<span className="amount">{price}</span>
            <span className="time text-body-color">/</span>
          </h3>
