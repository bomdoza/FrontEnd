...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden pb-16 pt-[120px] h-[550px] sm:h-[500px] md:h-[560px] xl:h-[650px] md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px] bg-cover bg-center"        
        style={{ backgroundImage: 'url("/images/hero/background/background1df.png")' }}
      >
