...
const ExcellenceSection = () => {
  return (
    <section className="py-16 sm:py-12 md:py-16 mb-16 sm:mb-2">
        <div className="container mx-auto">
            ...
            <p className='text-base text-center !leading-relaxed text-body-color md:text-lg mb-8'>
            ...
            <div className="grid grid-cols-1 gap-x-14 gap-y-32 sm:gap-y-20 md:gap-y-28 lg:gap-y-20 md:grid-cols-2 lg:grid-cols-2">
